...
class DeveloperPlaygroundScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          ...
          style: GoogleFonts.manrope(fontWeight: FontWeight.bold, color: BlushyColors.text),
        ),
              ...
              _buildDevButton(
                ...
                onPressed: () {
                  ...
                  _bypassAndLaunchHome(
                    ...
                    dob: DateTime.now().subtract(const Duration(days: 365 * 28)),
                    lifeStage: 'tryingToConceive',
                  );
                },
              ),
  ...
  Widget _buildSectionTitle(String title) {
    return Padding(
      ...
      child: Text(
        title,
        style: GoogleFonts.manrope(fontSize: 12, fontWeight: FontWeight.bold, color: BlushyColors.primary, letterSpacing: 1.2),
      ),
    );
  }
