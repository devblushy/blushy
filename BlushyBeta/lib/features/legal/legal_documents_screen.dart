...
class _LegalDocumentsScreenState extends State<LegalDocumentsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          _currentTab == LegalTab.privacyPolicy ? 'Privacy Policy' : 'Terms & Conditions',
  ...
  Widget _buildPrivacyPolicyContent() {
    return Column(
      ...
      children: [
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  ...
                  style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w600, color: const Color(0xFF2D2529), height: 1.4),
                ),
              ),
            ],
          ),
        ...
        _buildBulletPoint('Sia AI Companion Interactions', 'Text prompts, voice call audio snippets (processed in real-time), and personal memory notes you request Sia to remember.'),
        ...
        _buildBulletPoint('Sia AI Companion', 'Providing personalized conversational support, memory retention of your stated preferences, and voice call interaction.'),
        ...
        _buildClickableBulletPoint(
          label: 'Right to Erasure (Delete Account)',
          ...
          suffixText: '. Account deletion permanently wipes your profile, period history, Sia chat history, and partner connection logs from our primary databases.',
        ),
  ...
  Widget _buildTermsContent() {
    return Column(
      ...
      children: [
        _buildDocumentHeader(
          title: '⚖️ Terms and Conditions (Terms of Service)',
          effectiveDate: 'July 28, 2026',
          lastUpdated: 'July 28, 2026',
          appUrl: 'https://blushy.life',
        ),
        ...
        _buildParagraph(
          'By downloading, accessing, or using Blushy (including the mobile application, website, Sia AI Companion, partner feature, or community hub), you agree to be bound by these Terms and Conditions ("Terms"). If you do not agree to these Terms, please do not use the app.',
        ),
        ...
        _buildParagraph('When participating in the Blushy Community or using Sia AI Companion, you agree NOT to:'),
        ...
        _buildSectionTitle('5. Sia AI Companion & Automated Response Notice'),
        _buildBulletPoint('Nature of AI', 'Sia is an artificial intelligence conversational assistant designed for empathetic wellness support and casual conversation.'),
        _buildBulletPoint('No Professional Consultation', 'Sia does not act as a licensed therapist, clinical psychologist, or doctor.'),
  ...
  Widget _buildDocumentHeader({
    ...
    return Column(
      ...
      children: [
        Text(
          title,
          style: GoogleFonts.poppins(fontSize: 22, fontWeight: FontWeight.bold, color: const Color(0xFF2D2529)),
        ),
        ...
        Wrap(
          ...
          children: [
            Text(
              ...
              style: GoogleFonts.poppins(fontSize: 12, color: const Color(0xFF7A6B72), height: 1.4),
            ),
            MouseRegion(
  ...
  Widget _buildSectionTitle(String title) {
    return Padding(
      ...
      child: Text(
        title,
        style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold, color: const Color(0xFFF76B8A)),
      ),
    );
  }
  ...
  Widget _buildSubsectionTitle(String title) {
    return Padding(
      ...
      child: Text(
        title,
        style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w600, color: const Color(0xFF2D2529)),
      ),
    );
  }
  ...
  Widget _buildParagraph(String text) {
    return Padding(
      ...
      child: Text(
        text,
        style: GoogleFonts.poppins(fontSize: 13, color: const Color(0xFF4A3B43), height: 1.5),
      ),
    );
  }
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: RichText(
              text: TextSpan(
                style: GoogleFonts.poppins(fontSize: 13, color: const Color(0xFF4A3B43), height: 1.4),
                children: [
        ...
        children: [
          ...
          Expanded(
            child: Wrap(
              crossAxisAlignment: WrapCrossAlignment.center,
              children: [
                Text('$label: ', style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.bold, color: const Color(0xFF4A3B43))),
                if (prefixText.isNotEmpty)
                  Text(prefixText, style: GoogleFonts.poppins(fontSize: 13, color: const Color(0xFF4A3B43))),
                MouseRegion(
                  cursor: SystemMouseCursors.click,
                  child: GestureDetector(
                ...
                if (suffixText.isNotEmpty)
                  Text(suffixText, style: GoogleFonts.poppins(fontSize: 13, color: const Color(0xFF4A3B43))),
              ],
            ),
          ),
        ],
